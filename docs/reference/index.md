...
- [`apa_table()`](https://ekarinpongpipat.com/eepR/reference/apa_table.md)
  : apa_table
...
- [`gen_contrast_blank()`](https://ekarinpongpipat.com/eepR/reference/gen_contrast_blank.md)
  : Create a Blank COPE / Contrast Matrix from a Model or Predictor
  Names
...
- [`gen_data_predict()`](https://ekarinpongpipat.com/eepR/reference/gen_data_predict.md)
...
- [`model()`](https://ekarinpongpipat.com/eepR/reference/model.md) :
  model
...
- [`eval_cmd()`](https://ekarinpongpipat.com/eepR/reference/eval_cmd.md)
  : eval_cmd
- [`initialize_optparse()`](https://ekarinpongpipat.com/eepR/reference/initialize_optparse.md)
  : initialize_optparse
- [`mkdir_if_dne()`](https://ekarinpongpipat.com/eepR/reference/mkdir_if_dne.md)
  : mkdir_if_dne
- [`tryCatch2()`](https://ekarinpongpipat.com/eepR/reference/tryCatch2.md)
  : tryCatch2
...
- [`compare_models()`](https://ekarinpongpipat.com/eepR/reference/compare_models.md)
  : compare_models
- [`cv_kfold_split_file()`](https://ekarinpongpipat.com/eepR/reference/cv_kfold_split_file.md)
  : cv_kfold_split_file
- [`error_msg()`](https://ekarinpongpipat.com/eepR/reference/error_msg.md)
  : error_msg
- [`get_age_yrs()`](https://ekarinpongpipat.com/eepR/reference/get_age_yrs.md)
  : get_age_yrs
- [`info_msg()`](https://ekarinpongpipat.com/eepR/reference/info_msg.md)
  : info_msg
- [`initialize_parallel_computing()`](https://ekarinpongpipat.com/eepR/reference/initialize_parallel_computing.md)
  : initialize_parallel_computing
