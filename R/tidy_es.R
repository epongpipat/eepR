#' tidy_es
#' @description a modification of the tidy command to adds the effect size (confidence intervals for the regression coefficient and adjusted R^2)
#' @concept stats
...
#' @examples tidy_es(lm(salary ~ yrs.since.phd, carData::Salaries))
