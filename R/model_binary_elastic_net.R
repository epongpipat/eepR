...
#' @examples
#' # to be added
model_binary_elastic_net <- function(data, y, alpha_list = seq(0.0001, 0.9999, 0.0001)) {
  ...
  model <- glmnet(x, y, family = "binomial", lambda = cv_elastic_net$lambda.1se, alpha = cv_elastic_net$alpha)
