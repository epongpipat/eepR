# Getting help with eepR

Thanks for using eepR. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/eepR/issues) to make sure the 
